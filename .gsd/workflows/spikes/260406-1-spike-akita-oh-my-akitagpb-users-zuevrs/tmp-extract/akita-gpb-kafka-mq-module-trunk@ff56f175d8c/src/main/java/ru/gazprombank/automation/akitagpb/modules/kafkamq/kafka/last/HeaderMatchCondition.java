...
public class HeaderMatchCondition extends MatchCondition {
  // Конструктор
  public HeaderMatchCondition(String field, boolean required, List<Condition> conditions) {
  ...
  public static class Builder {
    ...
    public HeaderMatchCondition build() {
      return new HeaderMatchCondition(field, required, conditions);
    }
  }
